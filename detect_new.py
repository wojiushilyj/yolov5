...
class detect_api:
    def __init__(self):
        ...
        self.parser.add_argument('--conf-thres', type=float, default=0.27, help='object confidence threshold')
        self.parser.add_argument('--iou-thres', type=float, default=0.50, help='IOU threshold for NMS')
